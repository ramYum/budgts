    ...
    <div className="space-y-4 pt-1">
      ...
      <div className="card space-y-3 rounded-2xl border border-hairline p-4">
        ...
        <p className="text-sm text-muted">
          Your bank credentials never reach Budgts — bank connections go through Plaid, which hands
          Budgts a secure token, not your username or password.
        </p>
        <p className="text-sm text-muted">
        ...
        <p className="text-sm text-muted">
          Budgts can read your account and transaction data to help you budget. It cannot send money,
