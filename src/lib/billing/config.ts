 ...
 *
 * Budgts does not send its own trial-end reminder (owner decision 2026-09-22, superseding the earlier plan): no
 * email/notification config lives here. Apple/Google send any store-required billing notices themselves.
 */
...
export interface BillingConfig {
  ...
  /** Public base URL of THIS deployment, used for links (e.g. the account-deletion manage-subscription link). */
  siteUrl: string;
}
